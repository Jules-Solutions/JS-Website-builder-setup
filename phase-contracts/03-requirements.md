...
- **Reference-data load** — the agent may surface 2026 B2B persona templates and conversion-design playbooks when the user wants structured guides (catalogued in `${CLAUDE_PLUGIN_ROOT}/reference/seo-checklists/` and external resources cited in `Reference materials`).
