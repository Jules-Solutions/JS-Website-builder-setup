...
- **Plugin corpus — voice exemplars** (for fresh-generation prompts): `${CLAUDE_PLUGIN_ROOT}/reference-corpus/voice-archetypes/` — agent uses representative voice-guide phrasings as model when prompting the user to freewrite or voice-note
