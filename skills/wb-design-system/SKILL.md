...
- `Workstreams/website-builder/cross-cutting/DESIGN-resource-curation.md` — how `.website-builder/library/design-systems/` + the awesome-design-md corpus subset surface (read for inspiration, never imported).
