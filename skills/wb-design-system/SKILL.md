...
- `Workstreams/website-builder/skills/DESIGN-skill-uiuxpromax.md` — the MVP primary design-skill flavor (locked decision 55). The 50+ styles / 161 palettes / 57 font pairings / 99 UX guidelines surface it drives, plus the option-narrowing discipline and composition/conflict rules.
- `Workstreams/website-builder/cross-cutting/DESIGN-context7-integration.md` — context7 is a foundation tool (locked decision 23); the invocation pattern + when it fires at phase 17.
- `Workstreams/website-builder/cross-cutting/DESIGN-resource-curation.md` — how `reference/design-systems/` + the awesome-design-md corpus subset surface (read for inspiration, never imported).
- `Workstreams/website-builder/foundation/DESIGN-architecture.md` § Skills + § Stack-agnostic output design — why tokens are stack-independent and survive a stack switch.
