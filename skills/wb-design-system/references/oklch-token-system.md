...
- `${CLAUDE_PLUGIN_ROOT}/reference-corpus/design-systems/` — Material 3 / Apple HIG / IBM Carbon excerpts. Read for **how a mature system maps semantic roles** (their role taxonomy), not for their specific colors.
