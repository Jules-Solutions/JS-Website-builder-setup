...
>
> See `DESIGN-architecture.md` (lines 38, 182-191), `foundation/DESIGN-project-scaffold.md`, `cross-cutting/DESIGN-skill-distribution.md`, and `cross-cutting/DESIGN-secrets-and-keys.md` for the design context this skill implements.
...
- Pointer to the design surface in the Jules.Life vault: `DESIGN-project-scaffold.md`
...
# See DESIGN-project-scaffold.md for schema details.
version: 1
...
- Architecture: `DESIGN-architecture.md` (skill load order, `wb-bootstrap` slot)
- Project scaffold: `DESIGN-project-scaffold.md` (canonical `.website-builder/` layout this skill creates)
- Skill distribution: `DESIGN-skill-distribution.md` (the `scripts/install-skills.sh` design + composition manifests)
- Secrets and keys: `DESIGN-secrets-and-keys.md` (`.env` vs 1Password hybrid + multi-machine limitation)
- Locked decisions 15, 29, 32, 33, 43, 44, 48, 55: STATE doc at `website-builder.md`
