...
- **Phase 14's wireframe is the structural anchor for phases 15-18.** Skipping it pushes structure-discovery into the build phase (~60% rework). The wireframe constrains the section specs (15) and the copy length (16).
